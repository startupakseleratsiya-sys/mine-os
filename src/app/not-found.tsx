  ...
  return (
    <div className="min-h-screen bg-[#F5F4EE] flex flex-col items-center justify-center gap-5 p-8 text-center text-[#13251f]">
      ...
      <div className="flex gap-3">
        <Link href="/dashboard" className="rounded-xl bg-[#163e32] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#0e3026]">
          Kabinet
        </Link>
        <Link href="/courses" className="rounded-xl border border-[#E2E4DF] bg-white px-5 py-2.5 text-sm font-semibold hover:bg-[#f5f4ee]">
          Kurslar
        </Link>
      </div>
    </div>
