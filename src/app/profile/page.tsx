  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#f3f1eb] flex flex-col items-center justify-center gap-4">
        ...
        <Link href="/sign-in?next=/profile" className="text-sm font-semibold text-[#163e32] underline">
  ...
  return (
    <div className="min-h-screen bg-[#f3f1eb] text-[#13251f]">
      ...
      <main className="mx-auto max-w-[800px] px-4 py-10 sm:px-6 sm:py-16">
        <div className="mb-8">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-[#527264] mb-3">Hisob sozlamalari</p>
                  ...
                  {editing ? (
                    <div className="flex items-center gap-2 w-full max-w-sm">
                      <input
                        ...
                        className="flex-1 min-w-0 text-2xl font-bold bg-transparent border-b-2 border-[#163e32] outline-none py-1"
                      ...
                      <button
                        ...
                        disabled={saving}
                        className="grid size-9 shrink-0 place-items-center rounded-full bg-[#163e32] text-white hover:bg-[#0e3026] disabled:opacity-50 transition-colors"
                        aria-label="Saqlash"
                      >
                      ...
                      <button
                        ...
                        className="grid size-9 shrink-0 place-items-center rounded-full border border-[#E2E4DF] hover:bg-[#f5f4ee] transition-colors"
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="grid size-8 shrink-0 place-items-center rounded-lg text-[#65736d] hover:bg-[#f5f4ee] hover:text-[#0f2017] transition-colors"
          ...
          <div className="bg-white rounded-3xl border border-[#E2E4DF] p-6 sm:p-7">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between gap-3 py-3 border-b border-[#f5f4ee]">
                ...
                >
                  {emailConfirmed ? "Tasdiqlangan" : "Tasdiqlanmagan"}
                </span>
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-[#65736d]">
                  {resetState === "sent"
                    ? "Havola emailingizga yuborildi. Pochtani tekshiring."
                    : resetState === "error"
                      ? "Yuborib bo'lmadi. Birozdan keyin qayta urinib ko'ring."
                      : "Parolni o'zgartirish uchun emailga havola yuboriladi"}
                </p>
              </div>
              <button
                onClick={() => void handlePasswordReset()}
                disabled={resetState === "sending" || resetState === "sent"}
                className="shrink-0 text-xs font-semibold text-[#163e32] hover:underline disabled:opacity-50 disabled:no-underline"
              >
                {resetState === "sending" ? "Yuborilmoqda..." : resetState === "sent" ? "Yuborildi" : "O'zgartirish"}
              </button>
            </div>
          </div>
