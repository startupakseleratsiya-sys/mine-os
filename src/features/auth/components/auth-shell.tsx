...
export function AuthShell({
  ...
  return (
    <main className="grid min-h-screen bg-[#f3f1eb] text-[#13251f] lg:grid-cols-[0.9fr_1.1fr]">
      {/* Left — form */}
      <section className="flex flex-col px-5 py-7 sm:px-10 lg:px-16 lg:py-10">
        ...
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <span className="text-xl font-semibold tracking-tight">finora</span>
        </Link>
        ...
        <div className="my-auto mx-auto w-full max-w-[430px] py-14">
          ...
          <h1 className="mt-4 text-4xl font-semibold tracking-[-0.045em]">{title}</h1>
          <p className="mt-3 text-sm leading-6 text-[#6b7872]">{description}</p>
          {children}
        </div>

        <p className="text-center text-[10px] text-[#87918d]">
      ...
      <aside className="relative hidden overflow-hidden bg-[#163e32] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-xl">
          <blockquote className="text-4xl font-medium leading-[1.2] tracking-[-0.035em]">
            &ldquo;Moliyaviy erkinlik katta daromaddan emas, ongli qarorlardan boshlanadi.&rdquo;
          </blockquote>
        ...
        <p className="relative text-xs text-[#8eaaa0]">Ta&apos;lim. Tushunish. Ishonchli qaror.</p>
      </aside>
    </main>
  );
}
