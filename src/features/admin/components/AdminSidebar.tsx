...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-full md:w-64 border-b md:border-b-0 md:border-r border-[#13251f]/10 bg-white px-4 py-4 md:py-6 flex md:flex-col md:min-h-screen shrink-0 gap-4">
      <div className="flex items-center gap-2.5 px-2 md:mb-8">
        ...
        <span className="font-semibold tracking-tight hidden sm:block">Finora Admin</span>
      </div>
      ...
      <nav className="flex md:flex-col flex-1 gap-1 overflow-x-auto">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "bg-[#f3f1eb] text-[#13251f]" : "text-[#65736d] hover:bg-[#f3f1eb] hover:text-[#13251f]"
              )}
            >
        ...
        <Link
          href="/dashboard"
          className="flex shrink-0 items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-[#65736d] hover:bg-[#f3f1eb] hover:text-[#13251f] transition-colors"
        >
          <ArrowLeft className="size-4 shrink-0" />
          <span className="hidden sm:inline">Kabinetga</span>
        </Link>
      </nav>
